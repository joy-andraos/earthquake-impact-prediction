...
Here is the link to our dataset from Kaggle with 0 previous work (there are 2 tables, we chose to work on the data from 1995 to 2023 earthquake_1995-2023.csv):
...
**The context of our project is risk analysis:** assessing the significance of future earthquakes or tsunamis. The quantitative response to predict is the numerical significance of a potential earthquake based on several factors such as its location.
